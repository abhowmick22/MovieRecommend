...
$\theta$, {\bf z} and 
{\bf w} and adding variational parameters lead us to variational model as in 
Figure~\ref{fig:lda-variational}, which has the following variational distribution:
