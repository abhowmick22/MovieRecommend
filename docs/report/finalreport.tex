...
\begin{figure}[ht]
\centering
\includegraphics[width=0.4\textwidth]{pmf_graphical_model.png}
...
we evaluate the out-of-matrix prediction of CTR by removing certain ratings fromthe rating matrix, remembering them as true ratings, computing the predicted
...
feature of CTR that CF does not possess).   
