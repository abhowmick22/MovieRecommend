# Function to take processed summaries, dump them as a feature vector of indices with respect to the vocabulary
import sys;
import re;

def dumpSummaryFeatures(summaryPath, dictionaryPath, summaryFeaturePath):
    ...
    vocabFile = open(dictionaryPath, 'r');
    ...
    featureFile = open(summaryFeaturePath, 'wb');
