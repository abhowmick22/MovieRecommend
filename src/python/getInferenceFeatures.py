...
#Splitting into training and testing, first index that we split on
startIndex = 45442;
...
movieLensIdFile = open('../../data/ldamodels/movieLensId.txt', 'wb');
inferenceFile = open('../../data/ldamodels/inferencefeatures.txt', 'wb');
trainingFile = open('../../data/ldamodels/trainingfeatures.txt', 'wb');
    ...
    if(mLensId in mapping.keys()):
        ...
        if(mapping[mLensId] in summaries.keys()):
            ...
            infMovieSummaries.append(summaries[mapping[mLensId]]);
                ...
                # Use these for training as well
                if(mLensId < startIndex):
                    trainSummaries.append(summaries[mapping[mLensId]]);
